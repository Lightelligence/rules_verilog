...
#
# 2. Update simmer
#    test_to_vcomp_aspect -> verilog_dv_test_cfg_info_aspect
...
echo $src_files | xargs sed -i 's/rtl_pkg/verilog_rtl_pkg/g'
echo $src_files | xargs sed -i 's/rtl_shell_static/verilog_rtl_shell/g'
echo $src_files | xargs sed -i 's/rtl_unit_test/verilog_rtl_unit_test/g'
echo $src_files | xargs sed -i 's/rtl_lint_test/verilog_rtl_lint_test/g'
echo $src_files
echo $src_files | xargs sed -i 's/dv_test_cfg/verilog_dv_test_cfg/g'
echo $src_files | xargs sed -i 's/dv_lib/verilog_dv_library/g'
echo $src_files | xargs sed -i 's/dv_tb/verilog_dv_tb/g'
echo $src_files | xargs sed -i 's/dv_unit_test/verilog_dv_unit_test/g'

echo $src_files | xargs sed -i 's/vcomp=/tb=/g'

echo $src_files | xargs sed -i 's/@verilog_tools/@rules_verilog/g'
